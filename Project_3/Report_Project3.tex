...
For a circular orbit, the centripetal force $F_c$ must be equal to the gravitational force, given by \ref{eq:GravityForce}, where we use $m = m_1$ and $M =m_2$. We can now calculate the orbital velocity $v_{orb}$ of a circular orbit with radius r:
...
\begin{figure} [H]
    ...
    \caption{The Earth's orbit, shown as blue lines, around the Sun, shown as a yellow dot. The motion is solved with VelocityVerlet, and plotted with $dt = 10^{-1}$ for a 10 year time period.}
...
\begin{figure} [H]
    ...
    \caption{The Earth's orbit, shown as blue lines, around the Sun, shown as a yellow dot. The motion is solved with EulerCromer, and plotted with $dt = 10^{-1}$ for a 10 year time period.}
