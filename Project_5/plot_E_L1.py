...
infiles = ['E_L1_file_omega=0_01.dat']#, 'E_L1_file_omega=0_5.dat', 'E_L1_file_omega=0_01.dat']
...
ax1.plot(data[0,:,0], data[0,:,1], color = 'k', label = 'Energy')
...
ax2 = ax1.twinx()
ax2.plot(data[0,:,0], data[0,:,2],color = 'r', linestyle = '--')
