...
\begin{figure} [H]
    \centering
    \includegraphics[scale=0.65]{E_L1_variance_omega=0_01.png}
...
\end{figure}
For $\omega = 1.0, 0.5, 0.01$ we found the optimal parameters and resulting energy and variance as shown in table \ref{tab:Psi2results}.
\begin{table} [H]
\centering
